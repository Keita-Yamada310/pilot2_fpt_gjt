...
// GJTは29項目中、奇数番号を文法文、偶数番号を非文法文として提示します（文法文15、非文法文14）。
...
const FPT_ITEMS = [
  ...
  { item_id: 23, verb: "make", category: "v-obj-comp[bare-inf]", target_pattern: "make + O + bare V" },
  { item_id: 24, verb: "watch", category: "v-obj-comp[bare-inf]", target_pattern: "watch + O + bare V" },
  { item_id: 25, verb: "take", category: "v-obj-obl[to]", target_pattern: "take + O + to NP" },
  { item_id: 26, verb: "send", category: "v-obj-obl[to]", target_pattern: "send + O + to NP" },
...
const GJT_ITEM_PAIRS = [
  ...
  { item_id: 23, category: "v-obj-comp[bare-inf]", verb: "make", pattern: "make + O + bare V", grammatical_sentence: "The movie made me cry.", ungrammatical_sentence: "The movie made me to cry.", error_type: "Extra infinitival to" },
  { item_id: 24, category: "v-obj-comp[bare-inf]", verb: "watch", pattern: "watch + O + bare V", grammatical_sentence: "We watched the boy play football.", ungrammatical_sentence: "We watched the boy to play football.", error_type: "Extra infinitival to" },
  { item_id: 25, category: "v-obj-obl[to]", verb: "take", pattern: "take + O + to NP", grammatical_sentence: "My father took me to school.", ungrammatical_sentence: "My father took to school me.", error_type: "Argument order" },
  { item_id: 26, category: "v-obj-obl[to]", verb: "send", pattern: "send + O + to NP", grammatical_sentence: "She sent the letter to Tom.", ungrammatical_sentence: "She sent to Tom the letter.", error_type: "Argument order" },
